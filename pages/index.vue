      ...
      <div class="row pt-4">
        <div class="col-sm-12">
          ...
          <div class="element-wrapper">
            ...
            <h6 class="element-header">Support Service Dashboard</h6>
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          >
                            ...
                            <div class="label">Agent Replies</div>
                            <div class="trending trending-up-basic">
                              <span>12%</span
                              ><i class="os-icon os-icon-arrow-up2"></i>
                            </div>
                        ...
                        <div class="col-sm-6">
                          ...
                          >
                            ...
                            <div class="label">New Replies</div>
                            <div class="trending trending-down-basic">
                              <span>12%</span
                              ><i class="os-icon os-icon-arrow-down"></i>
                            </div>
      ...
      <div class="row">
        <div class="col-sm-7 col-xxl-6">
          ...
          <div class="element-wrapper">
            ...
            <h6 class="element-header">Customers with most tickets</h6>
                ...
                <table class="table table-lightborder">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-right">
                        <span>Today </span
                        ><span class="smaller lighter">1:52pm</span>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td class="text-right">
                        <span>Yesterday </span
                        ><span class="smaller lighter">5:34pm</span>
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td class="text-right">
                        <span>Jan 15th </span
                        ><span class="smaller lighter">3:14pm</span>
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <div class="col-sm-5 col-xxl-6">
          ...
          <div class="element-wrapper">
            ...
            <h6 class="element-header">Questions per Product</h6>
            <div class="element-box">
                ...
                <table class="table table-padded">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="smaller lighter">
                          I have enabled the software for you, you can try
                          now...
                        </div>
                      </td>
                      <td>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a class="badge badge-warning-inverted" href=""
                          >Restaurants</a
                        >
                      </td>
                      <td class="nowrap">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="user-with-avatar">
                          <img alt="" src="img/avatar4.jpg" /><span
                            >Katy Pilsner</span
                          >
                        </div>
                      </td>
